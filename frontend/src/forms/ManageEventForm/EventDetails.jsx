      ...
      >
        <div className="flex flex-col gap-2">
          ...
          <p className="font-poppins text-lg max-sm:text-base">
            List impactful events for rural communities. Join us in making a
            difference! Seamless registration, mobile notifications.
          </p>
          {/* Seprator */}
          ...
          <div className="w-1/2 max-sm:w-full p-4 border rounded-md flex gap-2 flex-col items-start">
            <div>
              ...
              <p className="font-poppins text-base max-sm:text-sm ">
                Provide a brief overview of the event, including its purpose,
                activities, and how it will benefit rural communities. Be
                ...
                <div className="flex flex-col gap-1">
                  <div className="gap-1 flex flex-col mt-2">
                    ...
                    <p className="font-poppins font-normal text-base max-sm:text-sm ">
                      Please choose appropriate image for the event
                    </p>
                  </div>
