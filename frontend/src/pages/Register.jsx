    ...
    return (
        <form className="flex flex-col gap-5 " onSubmit={onSubmit}>
            <div className="gap-2 flex flex-col">
                <h2 className="text-3xl font-bold font-grotesk text-lightgreen">Create an Account</h2>
                <p className="font-poppins text-lg max-sm:text-base">Quick, secure account creation: Easy steps to access all features.</p>
                {/* Seprator */}
            ...
            <div className="p-4 gap-2 border border-lightgray font-grotesk rounded-lg ">
                <div className="flex max-sm:flex-col">
                    <div className="w-1/2 max-sm:w-full">
                        <img src={SignUp} alt="Sign Up" className="w-full h-full pointer-events-none" />
                    </div>
                    <div className="w-1/2 max-sm:w-full flex-col p-4 border rounded-lg">
                        <div className="gap-2 flex flex-col">
                            <h2 className="text-2xl font-bold font-grotesk text-black">Enter your details</h2>
                            {/* Seprator */}
                            <div className="h-px my-1 bg-black  w-full">
                            </div>
                        </div>  
