...
const Product = () => {
  ...
  return (
    <div className="space-y-6 border p-4 rounded-xl">
      <div>
        <h1 className="flex gap-1 font-grotesk text-3xl max-sm:text-xl">
          <h1 className="text-lightred font-semibold">Product Name:</h1>{" "}
          {product.name}
        </h1>
        {/* Seprator */}
      ...
      <div className="flex max-sm:flex-col gap-4 max-sm:gap-4 w-full justify-between">
        ...
        <div className="w-1/2 flex flex-col max-sm:w-full gap-2">
          <div className="flex flex-col h-full border p-4 rounded-lg border-lightgray">
            <h2 className="text-xl max-sm:text-lg font-bold font-grotesk text-black mb-3">
              Product Details
            </h2>
            {/* Seprator */}
            <div className="h-px my-1 bg-black border-[1px] border-lightgray w-full mb-3"></div>
            ...
            <div className="flex flex-col items-end w-full justify-between font-grotesk">
              <div className="flex justify-between w-full">
                <span className="flex gap-1">
                  <div className="font-medium text-lightgreen">Quantity :</div>{" "}
                  {product.quantity}
                </span>
                <span className="flex gap-1">
                  <div className="font-medium text-lightgreen">Price/kg:</div>{" "}
                  {product.price}₹
                </span>
              </div>
            </div>
